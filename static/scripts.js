...
function contactUs() {
  ...
  if (contactForm) {
    contactForm.addEventListener("submit", function () {
      const submitBtn = this.querySelector(".contact-form-submit-btn");
      if (submitBtn) {
        submitBtn.innerHTML = `
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="animate-spin" style="width:18px;height:18px;fill:white">
